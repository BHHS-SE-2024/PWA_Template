...
2. Populate a text file with a list of folders you need at the root of your project.
...
3. Run a BASH script to read the text file and create the folders listed in it.
...
4. Populate the file with a list of files you need at the root of your project.
...
5. Run a BASH script to read the text file and create the files listed in it.
...
2. Insert the block content into index.html, you will add more later.
...
3. Configure the app.js to initiate the servicework.js by inserting the JS. This ensures that when the window (app) loads the serviceworker.js is called to memory.
...
4. Configure the serviceworker.js by inserting the JS. The serviceworker.js, as the name suggests, is the file that does all the work in a PWA, including caching and API integration for the [WEB APIs](https://developer.mozilla.org/en-US/docs/Web/API).
